...
import static DIV2_751.Q2Solution2.CodeForces.*;
// Index 1024 out of bounds for length 0 ERROR
//30 MINS LEFT
public class Q2Solution2{
    ...
    public static void main(String[] args) {
        ...
        while (t-->0){
            ...
            for (int i = 0; i < 51; i++) {
                ...
                for (int j = 0; j < n; j++) {
                    occur[input.get(j)] +=1;
                   // occur.set((input.get(j)),occur.get(input.get(j))+1);
                }
                for (int j = 0; j < n; j++) {
                    input.set(j,occur[j]);
                }
                res.add(new ArrayList<>());
                res.get(i+1).addAll(input);
            }//here res will have our transforms array

            //need to check for the queries
            int q = I();
            while (q-->0){
                int x,k;
                x = I();
                ...
                if (k>50) k = 50;
                System.out.println(res.get(k).get(x-1));
            }
        }
    }
    ...
    static class CodeForces {
        static DIV2_751.FastReader sc=new DIV2_751.FastReader();
        ...
        public static class myComp implements Comparator<DIV2_751.CodeForces.pair>
        {
            //sort in ascending order.
            public int compare(DIV2_751.CodeForces.pair p1, DIV2_751.CodeForces.pair p2)
            {
                if(p1.a==p2.a)
                    return 0;
                else if(p1.a<p2.a)
        ...
        public static class myComp1 implements Comparator<DIV2_751.CodeForces.pair1>
        {
            //sort in ascending order.
            public int compare(DIV2_751.CodeForces.pair1 p1, DIV2_751.CodeForces.pair1 p2)
            {
                if(p1.a==p2.a)
                    return 0;
                else if(p1.a<p2.a)
        ...
        public static ArrayList<DIV2_751.CodeForces.pair1> mergeIntervals(ArrayList<DIV2_751.CodeForces.pair1> arr)
        {
            //****************use this in main function-Collections.sort(arr,new myComp1());
            ArrayList<DIV2_751.CodeForces.pair1> a1=new ArrayList<>();
            if(arr.size()<=1)
                return arr;
            a1.add(arr.get(0));
            int i=1,j=0;
            while(i<arr.size())
            {
                ...
                else if(a1.get(j).b>=arr.get(i).a)
                {
                    ...
                    long b=arr.get(i).b;
                    a1.remove(j);
                    a1.add(new DIV2_751.CodeForces.pair1(a,b));
                    i++;
                }
            }
            return a1;
