...
import Patterns.behavorialCaching.database.DbManagerFactory;
...
public class App {
    ...
    public static void main(final String[] args) {
        ...
        if (isDbMongo) {
            System.out.println("Using the Mongo database engine to run the application.");
        } else {
            System.out.println("Using the 'in Memory' database to run the application.");
        }
