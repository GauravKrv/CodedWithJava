...
class EncodingThreeStrings {
    ...
    public static void main(String[] args) {
        ...
        Result res = e.encodeThreeStrings("John","Johny","Janardhan");
        System.out.println(res.output1);
        System.out.println(res.output2);

        System.out.println(res.output3);
    ...
    public Result encodeThreeStrings(String input1, String input2, String input3){
        ...
        StringBuilder output1 = new StringBuilder (ip1parts[0] + ip2parts[2] + ip3parts[1]);
        StringBuilder output2 = new StringBuilder (ip1parts[1] + ip2parts[0] + ip3parts[2]);
        StringBuilder output3 = new StringBuilder (ip1parts[2] + ip2parts[1] + ip3parts[0]);
