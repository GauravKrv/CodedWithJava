...
public class CheckDirectedPath {
...
// representation
        ...
        public static void main(String args[])
        {
            ...
            CheckDirectedPath g = new CheckDirectedPath(4);
            g.addEdge(0, 1);
            g.addEdge(0, 2);
            g.addEdge(1, 2);
            g.addEdge(2, 0);
...
path between nodes, and depth-first search may traverse one adjacent node very deeply
before ever going into immediate neighbours
* */