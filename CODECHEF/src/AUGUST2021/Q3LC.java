...
public class Q3LC {
    ...
    static Main.Reader in = new Main.Reader(System.in);

    static void countTripletsBF(int n) throws IOException {
    ...
    static void countTripletsOP1(int n) throws IOException {
